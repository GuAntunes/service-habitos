...
public class ObjetivoResource {
	...
	@GetMapping
	public ResponseEntity<List<ObjetivoDTO>> lista(@PageableDefault(sort = "id", direction = Direction.ASC) Pageable paginacao) {

		List<Objetivo> objetivos = objetivoService.findAll(paginacao);
		return ResponseEntity.ok(ObjetivoDTO.converter(objetivos));
	}
